...
#TODO(improvement): Implement an __init__ with a dict.
...
class RAG_DTModel(Storage_DTModel):
    ...
    """
    def __init__(self, vector: list[float], embedder_name: str, storage_model: Storage_DTModel, id: str = "0"):
    ...
    def __init__(self, vector: list[float], embedder_name: str, 
                 url: str, title: str = "untitled", pages: str = "-1", text: str = "", 
